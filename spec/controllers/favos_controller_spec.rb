...
RSpec.describe FavosController, type: :controller do
  ...
  # FavosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      favo = Favo.create! valid_attributes
      get :show, params: {id: favo.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Favo" do
        expect {
          post :create, params: {favo: valid_attributes}, session: valid_session
        }.to change(Favo, :count).by(1)
      end

      it "renders a JSON response with the new favo" do
  ...
  describe "DELETE #destroy" do
    it "destroys the requested favo" do
      favo = Favo.create! valid_attributes
      expect {
        delete :destroy, params: {id: favo.to_param}, session: valid_session
      }.to change(Favo, :count).by(-1)
    end
  end
